import {
  pgTable, serial, text, integer, smallint,
  boolean, numeric, char, date, timestamp, index,
...
export const prices = pgTable('prices', {
  id: serial('id').primaryKey(),
  trackerId: integer('tracker_id').notNull().references(() => trackers.id, { onDelete: 'cascade' }),
